...
:lt => {
  ...
  :activities => "Veikla",
  :zeitgeist => "Zeitgeist",
  :current_country => "Dabartinė šalis",
  :entry => "Įrašas",
  :body => "Body?",
  ...
  #register, login, user profile, password_reset
  ...
  :logout => "Atsijungti",
  :must_be_logged_out => "Prašome pirma atsijungti nuo sistemos, tada grįžti į šitą puslapį",
  :how_to_reset_password => "Žemiau esančiame laukelyje įveskite savo el. pašto adresą ir gausite laišką su norodymais, kaip atstatyti savo slaptažodį",
  :instructions_sent => "Nurodymai, kaip atstatyti savo slaptažodį išsiųsti. Pasitikrinkite savo el. pašto dėžutę.<br />Taip pat patikrinkite, ar laiškas nebuvo išrūšiuotas kaip spam.",
  :forgot_password => "Pamiršau slaptažodį",
  :password_reset => "Slaptažodžio atstatymas",
  :password_reset_notice => "Atsiprašome, bet Jūsų profilis nebuvo rastas. Prašome kreiptis adresu admin@go-out.lt",
  :change_password => "Slaptažodžio keitimas",
  :no_such_user => "Tokio vartotojo nėra!",
  :no_such_email => "Tokio el. pašto adreso sistemoje nėra!",
  :password_updated => "Slaptažodis atnaujintas",
  :register_button => "Registruotis",
  :login_button => "Prisijungti",
  :enter_your_details => "Įveskite savo duomenis",
  :or_login_with_Facebook => "Arba prisijunkite per Facebook",
  ...
  :error_saving_possibly_duplicate => "Klaida išsaugant. Gal toks įrašas jau yra?",
  #user
